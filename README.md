...
- Пройти регистрацию для получения прав пользователя.
- Создавать новых авторов.
- Добавлять книги для авторов.
- Просматривать список авторов и книг.
Эти операции доступны только для авторизованных и аутентифицированных пользователей.
...
3. Запустите с использованием Docker:
